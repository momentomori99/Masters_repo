...
# =============================== Data ===============================
data_CNN = Data_CNN(dt=dt, intensity=intensity, kernel_size=9, thetas_deg=(0, 45, 90, 135), use_gabor=use_gabor)
train_dataset, test_dataset = data_CNN.load_MNIST()



#=============================== Brunel ===============================
brunel = Brunel(n_neurons=n_neurons, time=time, dt=dt, spatial=spatial, heterogeneity=heterogeneity, mnist_input=True, self_tuning=False, eta=eta, g=g, intensity=intensity)
brunel.build_brunel()
